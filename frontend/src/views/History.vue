                ...
                <div :hidden="currentNav !== 'Search'" style="margin: 20px">
                    ...
                    <div>
                        <div v-if="showError" class="search" style="font-weight: bolder;">
                            ...
                            <span class="url" @click="openUrl('https://discord.com/invite/5uFSepk87z')">Discord-support</span>
                             channel, we will help you on this. Your assets are safe.
                        </div>
                        <div class="search" style="margin-top: 20px;">
                            <span class="text" style="font-size: 16px;">To confirm that your Transaction Hash was generated from LayerX Bridge, you can:</span><br>
                            <span class="text">1. Make sure that this Transaction Hash was initiated at <span class="bold">LayerX Bridge official website</span>.</span><br>
...
.dark-theme .history-page >>> .el-pagination .btn-prev {
    background: center center no-repeat #191919;
    color: rgba(255, 255, 255, 0.6);
}
